...
# Create an endpoint to get all images
@app.get("/images/")
async def get_all_images():
    # Find all documents in the collection
    image_docs = images.find()

    # Convert the documents to a list of dictionaries
    image_list = [doc for doc in image_docs]
...
# Create an endpoint to get the title of an image with a given ID
@app.get("/images/{image_id}/title")
async def get_image_title_byimage_id(image_id: str):
    image = images.find_one({"image_id": int(image_id)})
    if image:
